            ...
            <div className="container-landing px-4 md:px-6">
                <div className="flex items-center justify-between h-16 md:h-20">
                    ...
                    <Link href="/" className="flex items-center gap-2 group">
                        <div className="h-8 w-8 rounded-lg bg-linear-to-br from-[#0052FF] to-[#4D7CFF] flex items-center justify-center">
                                ...
                                <div className="md:hidden border-t border-border py-4 space-y-2 w-full px-4">
                                    {navItems.map((item) => (
                                        <Link
                                            ...
                                            className={cn("block w-full px-4 py-2 rounded-lg text-muted-foreground hover:bg-muted hover:text-foreground transition-colors text-sm font-medium", pathname === item.href ? "bg-muted text-foreground" : "")}
                                        >
                                            {item.label}
                                        </Link>
                                    ))}
